...
const HomePage = () => {
  ...
  const [books, setBooks] = useState<BorrowedBooks[]>(mockData);
  const [newBookTitle, setNewBookTitle] = useState<string>("");
  const [newDueDate, setNewDueDate] = useState<string | Date>("");
  const [overdueBooks, setOverdueBooks] = useState<BorrowedBooks[]>([]);
